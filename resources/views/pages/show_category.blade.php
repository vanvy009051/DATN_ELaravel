        ...
        <div class="row">
            <div class="col-md-12">
                <div class="section-title">
                    ...
                    <h3 class="title">{{$name->category_name}}</h3>
                    @endforeach
                </div>
            </div>
            <div class="col-md-12">
                            ...
                            <div class="products-slick" data-nav="#slick-nav-1">
                                ...
                                <div class="product">
                                    ...
                                    <div class="product-body">
                                        ...
                                        <h3 class="product-name" style="height:30px;"><a href="#">{{ $product->title }}</a></h3>
                    ...
                    <div class="products-tabs">
                        <div id="tab2" class="tab-pane fade in active">
                            <div class="products-slick" data-nav="#slick-nav-2">
                                <div class="product">
                                    <div class="product-img">
                                        <img src="{{asset('./public/frontend/electro-master/img/product06.png')}}" alt="">
                                        <div class="product-label">
                                            <span class="sale">-30%</span>
                                            <span class="new">NEW</span>
                                        </div>
                                ...
                                <div class="product">
                                    <div class="product-img">
                                        <img src="{{asset('./public/frontend/electro-master/img/product07.png')}}" alt="">
                                        <div class="product-label">
                                            <span class="new">NEW</span>
                                        </div>
                                    </div>
                                ...
                                <div class="product">
                                    <div class="product-img">
                                        <img src="{{asset('./public/frontend/electro-master/img/product08.png')}}" alt="">
                                        <div class="product-label">
                                            <span class="sale">-30%</span>
                                        </div>
                                    </div>
                                ...
                                <div class="product">
                                    <div class="product-img">
                                        <img src="{{asset('./public/frontend/electro-master/img/product09.png')}}" alt="">
                                    </div>
                                    <div class="product-body">
                                        <p class="product-category">Category</p>
                                        <h3 class="product-name"><a href="#">product name goes here</a></h3>
                                ...
                                <div class="product">
                                    <div class="product-img">
                                        <img src="{{asset('./public/frontend/electro-master/img/product01.png')}}" alt="">
                                    </div>
                                    <div class="product-body">
                                        <p class="product-category">Category</p>
                                        <h3 class="product-name"><a href="#">product name goes here</a></h3>
