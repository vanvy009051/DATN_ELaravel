...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('public/backend/web/css/bootstrap.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('public/backend/web/css/my-login.css') }}">
</head>
...
<body class="my-login-page">
    ...
    <script src="{{asset('public/backend/web/js/jquery.min.js')}}"></script>
    <!-- <script src="bootstrap/js/popper.js"></script> -->
    <script src="{{asset('public/backend/web/js/bootstrap.js')}}"></script>
    <script src="{{asset('public/backend/web/js/my-login.js')}}"></script>
</body>
