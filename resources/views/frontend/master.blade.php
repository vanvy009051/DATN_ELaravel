        ...
        <div id="top-header">
            <div class="container">
                ...
                <ul class="header-links pull-right">
                    ...
                    if (!$id) { ?>
                        <li><a href="{{URL::to('/login')}}"><i class="fa fa-user-o"></i> Sign In</a></li>
                        <li><a href="{{URL::to('/sign-up')}}"><i class="fa fa-user-o"></i> Sign Up</a></li>
                    <?php
                    } else { ?>
                        <li><a href="#"><i class="fa fa-user-o"></i> Hi! <?php $name = Session::get('user_name');
                                                                            echo $name; ?></a>
                        </li>
                    ...
                    <div class="col-md-6">
                        <div class="header-search">
                            <form>
                                ...
                                <input class="input w-100" style="border-top-left-radius: 20px; border-bottom-left-radius: 20px" placeholder="Search here">
