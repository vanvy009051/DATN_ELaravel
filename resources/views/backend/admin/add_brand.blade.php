                ...
                <div class="position-center">
                    ...
                    <form role="form" action="{{URL::to('/save-brand')}}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="brand_name" class="form-control" id="exampleInputName" placeholder="Enter brand">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputDesc">Brand description</label>
                            <textarea style="resize:none;" rows="5" class="form-control" name="brand_desc" id="exampleInputDesc" placeholder="Brand description"></textarea>
                        </div>
                        <div class="form-group">
