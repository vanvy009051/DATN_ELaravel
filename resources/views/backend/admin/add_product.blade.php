                ...
                <div class="position-center">
                    ...
                    <form role="form" action="{{URL::to('/save-product')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="product_name" class="form-control" id="exampleInputName" placeholder="Enter category">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputName">Price</label>
                            <input type="text" name="product_price" class="form-control" id="exampleInputName" placeholder="Enter category">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputName">Image</label>
                            <input type="file" name="product_image" class="form-control" id="exampleInputName" placeholder="Enter category">
                        </div>
                        <div class="form-group">
