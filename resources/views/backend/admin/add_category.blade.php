                ...
                <div class="position-center">
                    ...
                    <form role="form" action="{{URL::to('/save-category')}}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="category_name" class="form-control" id="exampleInputName" placeholder="Enter category">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputDesc">Category description</label>
                            <textarea style="resize:none;" rows="5" class="form-control" name="category_desc" id="exampleInputDesc" placeholder="Category description"></textarea>
                        </div>
                        <div class="form-group">
