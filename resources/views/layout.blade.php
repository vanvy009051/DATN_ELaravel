                        ...
                        <div class="header-ctn">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="cart-dropdown">
                                    ...
                                    <div class="cart-btns">
                                        <a href="#">View Cart</a>
                                        <a href="/public/frontend/electro-master/checkout.html">Checkout <i class="fa fa-arrow-circle-right"></i></a>
                                    </div>
                                </div>
                            </div>
                            <!-- /Cart -->
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-xs-6">
                    <div class="shop">
                        <div class="shop-img">
                            <img src="{{('public/frontend/img/shop01.png')}}" alt="">
                        </div>
                        <div class="shop-body">
                ...
                <div class="col-md-4 col-xs-6">
                    <div class="shop">
                        <div class="shop-img">
                            <img src="{{('public/frontend/img/shop03.png')}}" alt="">
                        </div>
                        <div class="shop-body">
                ...
                <div class="col-md-4 col-xs-6">
                    <div class="shop">
                        <div class="shop-img">
                            <img src="{{('public/frontend/img/shop02.png')}}" alt="">
                        </div>
                        <div class="shop-body">
                        ...
                        <div class="products-tabs">
                            ...
                            <div id="tab1" class="tab-pane active">
                                <div class="products-slick" data-nav="#slick-nav-1">
                                    ...
                                    <div class="product">
                                        <div class="product-img">
                                            <img src="{{('public/frontend/img/product03.png')}}" alt="">
                                            <div class="product-label">
                                                <span class="sale">-30%</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="product">
                                        <div class="product-img">
                                            <img src="{{('public/frontend/img/product05.png')}}" alt="">
                                        </div>
                                        <div class="product-body">
                                            <p class="product-category">Category</p>
                                            <h3 class="product-name"><a href="#">product name goes here</a></h3>
                        ...
                        <div class="products-tabs">
                            ...
                            <div id="tab2" class="tab-pane fade in active">
                                <div class="products-slick" data-nav="#slick-nav-2">
                                    ...
                                    <div class="product">
                                        <div class="product-img">
                                            <img src="{{('public/frontend/img/product06.png')}}" alt="">
                                            <div class="product-label">
                                                <span class="sale">-30%</span>
                                                <span class="new">NEW</span>
                                            </div>
                                    ...
                                    <div class="product">
                                        <div class="product-img">
                                            <img src="{{('public/frontend/img/product07.png')}}" alt="">
                                            <div class="product-label">
                                                <span class="new">NEW</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="product">
                                        <div class="product-img">
                                            <img src="{{('public/frontend/img/product08.png')}}" alt="">
                                            <div class="product-label">
                                                <span class="sale">-30%</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="product">
                                        <div class="product-img">
                                            <img src="{{('public/frontend/img/product09.png')}}" alt="">
                                        </div>
                                        <div class="product-body">
                                            <p class="product-category">Category</p>
                                            <h3 class="product-name"><a href="#">product name goes here</a></h3>
